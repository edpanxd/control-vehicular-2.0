        ...
        <div class="col-lg-3 col-mb-3 col-sm-12">
            ...
            @if (new DateTime(" 01-01-$año") <=$actual and new DateTime(" 30-06-$año")>=
                ...
                <div class="small-box bg-red">
                 <div class="inner">
                    <h5>
                        Realizar Verificación Federal 1°P
                    </h5>
            ...
            @endif
            @if (new DateTime(" 01-07-$año") <=$actual and new DateTime(" 30-12-$año")>=
             $actual)
             <div class="small-box bg-red">
             <div class="inner">
                <h5>
                    Realizar Verificación Federal 2°P
                </h5>
                <p>Realizar Pago de verificación.</p>
             </div>
              <div class="icon">
            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box" style="background-color: #2E8B57">
                    ...
                    <div class="info-box-content">
                        ...
                        <h2 class="info-box-number">{{$formato= number_format((float)$sumaA,2)  }}</h2>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
