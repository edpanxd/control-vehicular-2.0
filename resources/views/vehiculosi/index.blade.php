        ...
        <tbody>
            @foreach ($valores as $valores)
                <tr>
                    ...
                    <td><a class="btn btn-primary" href="/Vehiculos_Nacionales/{{ $valores->archivo_pe }}" target="_blank">
                        <i class="far fa-file-pdf"></i>
                    ...
                    <td><a class="btn btn-primary" href="/Vehiculos_Nacionales/{{ $valores->archivo_titu }}" target="_blank">
                        <i class="far fa-file-pdf"></i>
                  ...
                  <th><a class="btn btn-danger eliminar" href="/vehiculoid/"><i
