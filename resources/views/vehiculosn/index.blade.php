        ...
        <tbody>
            @foreach ($valores as $valores)
                <tr>
                    ...
                    <td><a class="btn btn-primary" href="/Vehiculos_Nacionales/{{ $valores->archivo_fa }}" target="_blank">
                    ...
                    <td><a class="btn btn-primary" href="/Vehiculos_Nacionales/{{ $valores->archivo_refa }}" target="_blank">
                        <i class="far fa-file-pdf"></i>
                    ...
                    <td><a class="btn btn-primary" href="/Vehiculos_Nacionales/{{ $valores->archivo_car }}" target="_blank">
                        <i class="far fa-file-pdf"></i>
                  ...
                  <th><a class="btn btn-danger eliminar" href="/vehiculond/"><i
