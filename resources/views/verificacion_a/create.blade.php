    ...
    <form action="/verificacion_a" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="placa" name="verificacion" maxlength="20" required>
            </div>
            <div class="form-group col-md-6">
                <label for="pla" class="col-form-label">Vehículo:</label>
                <select class="custom-select select3" id="pla" name="pla"  required>
                    <option value=""></option>
                    @foreach ($selec2 as $selec2)
                        <option value="{{ $selec2->id }}" >{{ $selec2->nombre }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group col-md-6">
