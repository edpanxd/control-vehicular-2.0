...
@section('content_header')
    <h1>Registrar Vehiculos Nacionales</h1>
@stop

@section('content')
    <form action="/vehiculon" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="no_factura" maxlength="20" required>
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="refactura" maxlength="20" required>
            </div>
            <div class="form-group col-6 mb-4">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="carta_fa" maxlength="20" required>
            </div>
            <div class="form-group col-6 mb-4">
